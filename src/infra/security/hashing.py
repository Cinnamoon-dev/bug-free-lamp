...
JWT_ACCESS_SECRET_KEY = os.getenv(
    ...
    "5978c7af950f2a6097b4f07701b388a57abea6c4bbc36f09a7677306653e7796",
)
JWT_REFRESH_SECRET_KEY = os.getenv(
    "JWT_REFRESH_SECRET_KEY",
    "8f1b0cfb3694d16b60beccac61b2a40bec9e5fedbf59d1fed1c0cbb050f37236",
)
ALGORITHM = "HS512"
...
bcrypt_context = CryptContext(
    schemes=["sha512_crypt"], deprecated="auto", sha512_crypt__default_rounds=5000
)
...
def decode_token(
    jwt_token: str, secret_key: str | bytes, algorithms: list[str]
) -> dict[str, Any]:
    try:
